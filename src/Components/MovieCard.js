...
const MovieCard = (props) => {
  ...
  return (
    <Card className="card"
      ...
      <Card.Img variant="top" style={{height:"250px"}} src={props.movie.posterURL} />
      <Card.Body>
        ...
        <br/>
        <br/>
        <Link to={`/description/${props.movie.id}`}><Button variant="outline-primary">Description</Button>{' '}</Link>
      </Card.Body>
